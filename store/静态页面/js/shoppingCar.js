    ...
    var shoppingCar={
        ...
        init:function(){
            ...
            common.ajaxCommon('shopCarList',data,function(res){
                console.log(res);
                shoppingCar.render(res) ; //把后台的东西传进来.
            });
        ...
        ajax:function(data){
            shoppingCar.id = localStorage.getItem('id');
            shoppingCar.sessionId=localStorage.getItem('sessionId');

            $.ajax({

                url:'http://192.168.7.150:3000/shopCarList',
                data:{sessionId:shoppingCar.sessionId,id: shoppingCar.id,prdNum:""},
                type:"post",
                dataType:'json',

(function () {
    var ajaxView={
        ...
        webUrl: function (ins) {
            //访问老师的服务器地址
            //return "http://192.168.2.141:3000/"+ins;
        ...
        loadingBegin: function () {
            $("#loading").show();
            var str=$("#font-str");
            ab.int=setInterval(function () {// ab.int:声明变量,方便后面clearInterval的调用.
                str.append('.');
